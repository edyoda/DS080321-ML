...
train_data = train_gen.flow_from_directory('dataset/dataset/train', target_size = (128, 128),
                                           batch_size = 64, class_mode = 'binary')
test_data = test_gen.flow_from_directory('dataset/dataset/val', target_size = (128, 128),
                                         batch_size = 64, class_mode = 'binary')
